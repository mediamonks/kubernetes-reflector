...
## Build image locally
docker build -t kubernetes-reflector:10.0.0 -f src/ES.Kubernetes.Reflector/Dockerfile src/  
docker tag kubernetes-reflector:10.0.0 ghcr.io/mediamonks/kubernetes-reflector:10.0.0
...
docker push ghcr.io/mediamonks/kubernetes-reflector:10.0.0
